/**
* @module libresignag/queue/SlideList
*/

var Assert = require('libresignage/util/assert/Assert');

/**
* Class representing a list of slides.
*/
class SlideList {
	/**
	...
	*/
	...
	/**
	* Filter a SlideList against a set of key-value pairs.
	*
	* 'filter' is a dictionary of values that's compared against
	* the data array of all slides. Slides that match all values in
	* 'filter' are returned in a new SlideList object.
	*
	...
	*/
	...
	/**
	* Get the next slide in this SlideList.
	*
	* 'index' is the index of the slide preceding the returned
	* slide (ie. the index of the current slide). If wrap == true,
	* this function returns the first slide when no more slides exist.
	...
	* @param {boolean} wrap  Whether to wrap at the end of the queue.
	* @param {number}  dir   The iteration direction.
	*
	* @return {Slide} The next slide.
	*
	* @throws {AssertError} If dir is not 1 or -1.
	*/
	...
	/**
	* Get the internal slide array of a SlideList.
	*
	* @return {Slide[]} An array of slides.
	*/
	get_slides() { return this.slides; }

	/**
	* Get the length of a SlideList.
	*
	* @return {number} The length of the SlideList.
	*/
