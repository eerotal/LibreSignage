...
class UIInput extends UIElem {
	...
	*	Settings object.
	*
	* @throws {AssertError} If mod, getter, setter and clearer are not defined
	*                       in the settings object.	
	*/
	constructor(settings) {
		super(settings);
		Assert.assert('mod' in settings);
		Assert.assert('getter' in settings);
		Assert.assert('setter' in settings);
		Assert.assert('clearer' in settings);
