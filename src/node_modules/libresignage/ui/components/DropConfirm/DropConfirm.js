...
class DropConfirm {
	...
	*/
	constructor(container) {
		Assert.assert(container.id !== '', 'Container must have an ID.');
		...
		this.container.addEventListener('show.bs.dropdown', e => {
			this.container.dispatchEvent('component.dropconfirm.show');
		});
		this.container.addEventListener('hide.bs.dropdown', e => {
			this.container.dispatchEvent('component.dropconfirm.hide');
		});
		...
		this.container
			...
			.addEventListener('click', () => {
				this.container.dispatchEvent('component.dropconfirm.confirm');
			});
		this.container
			.querySelector('.dropconfirm-cancel')
			.addEventListener('click', () => {
				this.container.dispatchEvent('component.dropconfirm.cancel');
			});
	}
