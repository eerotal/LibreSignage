...
exports.MarkupClass = class MarkupClass {
	constructor(type, name, args, subst_open,
		...
		if (subst_open != null) {
			...
			throw new Error(
				'MarkupClass opening substitution undefined!'
			);
		}
	...
	_make_arg_rstr(arg_type) {
		...
		*/
		switch(arg_type) {
			...
			default:
				throw new Error(
					'Unknown class variable type: ' + arg_type
				);
		}
	}
	...
	_make_regexes() {
		...
		for (var a in this.args) {
			regex_str += ' ' + this._make_arg_rstr(
				this.args[a].arg_type
			);
		}
		regex_str += '\\]';
...
exports.MarkupParseError = class MarkupParseError extends Error {
...
exports.MARKUP = {
	'heading': new exports.MarkupClass(
		'block',
		'h',
		{'size': { 'arg_type': 'int' }},
	...
	'italic': new exports.MarkupClass(
		'block',
		'i',
		null,
	...
	'paragraph': new exports.MarkupClass(
		'block',
		'p',
		null,
		'<p>',
	...
	'container': new exports.MarkupClass(
		'block',
		'container',
		{
			'top': {'arg_type': 'int'},
	...
	'xcenter': new exports.MarkupClass(
		'block',
		'xcenter',
		null,
	...
	'columns': new exports.MarkupClass(
		'block',
		'columns',
		null,
	...
	'align-left': new exports.MarkupClass(
		'block',
		'align-left',
		null,
	...
	'align-center': new exports.MarkupClass(
		'block',
		'align-center',
		null,
	...
	'align-right': new exports.MarkupClass(
		'block',
		'align-right',
		null,
	...
	'align-justify': new exports.MarkupClass(
		'block',
		'align-justify',
		null,
...
exports.parse = function(str) {
	...
	while (tmp.length) {
		for (var k in exports.MARKUP) {
			match = exports.MARKUP[k].match(tmp);
			if (!match) {
				continue;
			}
			ret += match[1];
			...
			if (match[2] == 'open'
				...
				throw new exports.MarkupParseError(
					'Unexpected block "' + k + '" closed. Expected ' +
					'to close "' +  open[open.length - 1] + '".',
					_parser_ln_num
				);
			}
		}
