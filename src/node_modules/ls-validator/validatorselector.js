...
module.exports = class ValidatorSelector {
	...
	*/
	constructor(element, style, validators, hooks) {
		...
		*    is invalid. This should be a container <div> surrounding
		*    the actual input element. If you wan't to show a feedback
		*    message to the user when the input is invalid, you can add
		*    a <div> element within the styled container with the class
		*    'invalid-feedback'. If style === null no styling is used.
