/*
*  Parser for the LibreSignage markup parser. This file contains
...
RULES['VARNAME'] = RULES['BRACK_CLOSE'];

/*
*  Handle separate WHITESPACE and LITERALs as the same thing.
*/
...
function pmatch_rule_jrepr(rule, sep) {
	...
	*/
	...
	for (let t of rule.exp) {
		if (ret.length) {
			ret += sep + tokens.get_tok(t).repr;
		} else {
			ret += tokens.get_tok(t).repr;
		}
	}
	return ret;
}
