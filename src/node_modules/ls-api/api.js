...
exports.API = class API {
	constructor(config, callback) {
		...
		this.ENDP = {
			...
			SLIDE_LOCK_ACQUIRE: {
				uri:	"/api/endpoint/slide/slide_lock_acquire.php",
				method:	"POST",
				auth:	true
			},
			SLIDE_LOCK_RELEASE: {
				uri:	"/api/endpoint/slide/slide_lock_release.php",
				method:	"POST",
				auth:	true
			},
			SLIDE_UPLOAD_ASSET: {
				uri:	"/api/endpoint/slide/slide_upload_asset.php",
				method:	"POST",
				auth:	true
			},			
			...
			AUTH_GET_DATA: {
				uri:	"/api/endpoint/auth/auth_get_data.php",
				method: "GET",
				auth:	true
			},
