...
var APIEndpoints = require('./APIEndpoints').APIEndpoints;
var APISession = require('./APISession.js').APISession;

/**
* An object for interfacing with the LibreSignage HTTP API.
*/
class APIInterface {
	constructor(host) {
		/**
