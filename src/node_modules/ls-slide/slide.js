...
class Slide {
	...
	transpile_html_buffer() {
		this.html = markup.parse(util.sanitize_html(this.get('markup')));
	}
	...
	anim_hide_rev() { return this.anim_hide() + ' anim-reverse'; }
	anim_show()     { return Slide.ANIMATIONS[this.get('animation')].show; }
	anim_show_rev() { return this.anim_show() + ' anim-reverse'; }
}
