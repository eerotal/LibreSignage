...
exports.UIElem = class UIElem {
	...
	*    - perm    = The permission checking function. This should
	...
	*/
	constructor(elem, perm, enabler, attach, defer) {
		this.type = null;
		this.elem = elem;
		this.perm = perm;
		this.attach = attach;
		...
		if (enabler) {
			...
			/*
			*  Use a default enabler function. This works
			*  for all <input> elements (and similar).
			*/
...
exports.UIInput = class UIInput extends exports.UIElem {
	...
	*/
	constructor(
		...
		super(elem, perm, enabler, attach, defer);
		this.type = "input";

		this.mod = mod;         // Modification checking callback.
		this.getter = getter;   // Value getter.
		this.setter = setter;   // Value setter.
		this.clearer = clearer; // Input clearing function.
	}
